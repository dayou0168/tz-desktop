...
> 本文保存早期项目历史，包含已经过期的版本号、运行记录和构建状态，不应作为当前 Windows 构建命令使用。TZ Desktop 1.0.5 的当前权威构建入口是 [`TZ_WINDOWS_1.0.5_LTO_CODEX.zh-CN.md`](TZ_WINDOWS_1.0.5_LTO_CODEX.zh-CN.md)。
