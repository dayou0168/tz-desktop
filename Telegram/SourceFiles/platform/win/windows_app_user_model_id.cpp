...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"tianze.TZ.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"tianze.TZ";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"TZ.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"TZ/TZ.lnk"_q;
