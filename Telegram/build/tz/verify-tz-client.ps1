...
Assert-Contains 'Telegram\build\version' 'AppVersion         1000005'
Assert-Contains 'Telegram\build\version' 'AppVersionStrSmall 1.0.5'
Assert-Contains 'Telegram\build\version' 'AppVersionStr      1.0.5'
Assert-Contains 'Telegram\build\version' 'AppVersionOriginal 1.0.5'
Assert-Contains 'Telegram\SourceFiles\core\version.h' 'AppVersion = 1000005'
Assert-Contains 'Telegram\SourceFiles\core\version.h' 'AppVersionStr = "1.0.5"'
Assert-Contains 'Telegram\SourceFiles\tz\tz_client_contract.h' 'kVersion = u"1.0.5"'
Assert-Contains 'Telegram\SourceFiles\tests\tz_client_contract_tests.cpp' 'QStringView(u"1.0.5")'
Assert-Contains 'Telegram\Resources\winrc\Telegram.rc' 'FILEVERSION 1,0,5,0'
Assert-Contains 'Telegram\Resources\winrc\Telegram.rc' 'PRODUCTVERSION 1,0,5,0'
Assert-Contains 'Telegram\Resources\winrc\Telegram.rc' 'VALUE "FileVersion", "1.0.5.0"'
Assert-Contains 'Telegram\Resources\winrc\Telegram.rc' 'VALUE "ProductVersion", "1.0.5.0"'
Assert-Contains 'Telegram\Resources\winrc\Updater.rc' 'FILEVERSION 1,0,5,0'
Assert-Contains 'Telegram\Resources\winrc\Updater.rc' 'PRODUCTVERSION 1,0,5,0'
Assert-Contains 'Telegram\Resources\winrc\Updater.rc' 'VALUE "FileVersion", "1.0.5.0"'
Assert-Contains 'Telegram\Resources\winrc\Updater.rc' 'VALUE "ProductVersion", "1.0.5.0"'
Assert-Contains 'Telegram\Resources\uwp\AppX\AppxManifest.xml' 'Version="1.0.5.0"'
Assert-Contains '.github\workflows\tz-windows-release.yml' "TZ_VERSION: '1.0.5'"
Assert-Contains '.github\workflows\tz-windows-release.yml' 'name: TZ-1.0.5-windows-x64-build'
Assert-Contains '.github\workflows\tz-windows-release.yml' 'artifacts/release/TZ-1.0.5-Setup.exe'
Assert-Contains '.github\workflows\tz-windows-release.yml' 'artifacts/release/TZ-1.0.5-windows-x64.zip'
Assert-Contains '.github\workflows\tz-windows-release.yml' 'artifacts/release/TZ-1.0.5-symbols.zip'
...
foreach ($versionedPath in @(
    ...
    Assert-NotContains $versionedPath '1.0.4'
    Assert-NotContains $versionedPath '1000004'
    Assert-NotContains $versionedPath '1,0,4,0'
}
...
Assert-Contains 'README.md' '# TZ Desktop 1.0.5'
Assert-Contains 'docs\releases\1.0.5.zh-CN.md' '# TZ Desktop 1.0.5'
Assert-Contains 'docs\releases\1.0.5.zh-CN.md' 'Windows'
Assert-Contains 'docs\TZ_WINDOWS_1.0.5_LTO_CODEX.zh-CN.md' '# TZ Desktop 1.0.5 Windows LTO'
Assert-Contains 'docs\TZ_WINDOWS_1.0.5_LTO_CODEX.zh-CN.md' 'DESKTOP_APP_ENABLE_LTO=ON'
Assert-Contains 'docs\TZ_WINDOWS_1.0.5_LTO_CODEX.zh-CN.md' 'TZ-1.0.5-Setup.exe'
Assert-Contains 'Telegram\SourceFiles\tz\tz_client_contract.h' 'kLoginPasswordSettingsHint = u"TZ_LOGIN_PASSWORD_V1"'
Assert-Contains 'Telegram\SourceFiles\tz\tz_client_contract.h' 'LoginPasswordUpdatePayload('
Assert-Contains 'Telegram\SourceFiles\settings\sections\settings_privacy_security.cpp' 'security/tz_login_password'
Assert-Contains 'Telegram\SourceFiles\settings\sections\settings_privacy_security.cpp' 'MTPaccount_UpdatePasswordSettings('
Assert-Contains 'Telegram\SourceFiles\settings\sections\settings_privacy_security.cpp' 'Tz::LoginPasswordUpdatePayload(current, updated)'
Assert-Contains 'Telegram\Resources\langs\lang.strings' '"lng_tz_login_password_change"'
